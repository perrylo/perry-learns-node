import axios from 'axios'; // a nicer library for fetch
import dompurify from 'dompurify'; // a library for cleaning html to prevent XSS hacks, use whenever you set innerHTML
